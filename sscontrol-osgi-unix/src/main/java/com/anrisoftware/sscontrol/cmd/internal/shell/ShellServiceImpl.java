...
public class ShellServiceImpl implements ShellService {
    ...
    @Override
    public Shell create(Map<String, Object> args, Object parent,
            Threads threads, Object log, String command) {
        return shellFactory.create(args, parent, threads, log, command);
    }
